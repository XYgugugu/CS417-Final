...
namespace PVZ3D.Plants
{
    public class PlantBase : MonoBehaviour
    {
        ...
        public virtual bool CanUpgradeWith(PlantDefinition upgradeDefinition) => false;
        public virtual int GetUpgradeCost(PlantDefinition upgradeDefinition) => 0;
        public virtual string GetUpgradeName(PlantDefinition upgradeDefinition) => string.Empty;
        public virtual bool ApplyUpgrade(PlantDefinition upgradeDefinition) => false;
