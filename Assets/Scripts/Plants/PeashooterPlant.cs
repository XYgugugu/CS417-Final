...
namespace PVZ3D.Plants
{
    public class PeashooterPlant : PlantBase
    {
        ...
        {
            return !isDoublePeashooter
                && upgradeDefinition != null
                && upgradeDefinition.Archetype == PlantArchetype.Peashooter;
        }
        ...
        private void EnsureDoublePeashooterVisuals()
        {
            ...
            {
                secondaryMuzzleVisual = CreateUpgradePart(
                    "SecondMuzzle",
                    PrimitiveType.Cylinder,
                    new Vector3(0.28f, 0.95f, -0.18f),
                    new Vector3(0.09f, 0.26f, 0.09f),
                    new Color(0.2f, 0.68f, 0.22f),
                    Quaternion.Euler(90f, 0f, 0f));
            }

            if (upgradeLeafVisual == null)
            {
                upgradeLeafVisual = CreateUpgradePart(
                    "UpgradeLeaf",
                    PrimitiveType.Sphere,
                    new Vector3(-0.02f, 1.12f, -0.16f),
                    new Vector3(0.18f, 0.1f, 0.26f),
                    new Color(0.58f, 0.94f, 0.36f),
